            ...
            <div class="brand-content">
                ...
                <div class="animate-in delay-3">
                    <div class="d-flex justify-content-center gap-3 mt-4">
                        <a href="#" class="text-white"><i class="ri-facebook-fill fs-5"></i></a>
                        <a href="#" class="text-white"><i class="ri-twitter-fill fs-5"></i></a>
                        <a href="#" class="text-white"><i class="ri-linkedin-fill fs-5"></i></a>
                    </div>
                </div>
            </div>
        </div>
