        ...
        <div class="col-lg-8">
            <div class="text-center mb-5">
                <h1 class="fw-bold text-gradient-warning">
                    <i class="fas fa-edit me-2"></i> Modifier un partenaire
                </h1>
                <p class="lead text-muted">Mettez à jour les informations du partenaire</p>
            </div>

            <div class="card shadow-lg border-0 rounded-lg overflow-hidden">
                <div class="card-header bg-warning text-white py-3">
                    <h3 class="mb-0 fw-light"><i class="fas fa-tag me-2"></i> Édition d'un partenaire</h3>
                </div>
                
                <div class="card-body p-4 p-lg-5">
                    <form action="{{ route('partenaire.update', $partenaire->id) }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="nom" id="nom" class="form-control form-control-lg border-start-0" 
                                       value="{{ $partenaire->nom }}" placeholder="Ex: Électronique, Mode, etc." required>
                            </div>
                            <div class="invalid-feedback">
                                Veuillez entrer un nom de partenaire valide.
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <textarea name="description" id="description" class="form-control border-start-0" 
                                          rows="4" placeholder="Décrivez ce partenaire...">{{ $partenaire->description }}</textarea>
                            </div>
                        </div>
                        
                        <div class="d-grid gap-3 d-md-flex justify-content-md-end mt-5">
                            <a href="{{ route('partenaire.index') }}" class="btn btn-outline-secondary btn-lg rounded-pill me-md-2">
                ...
                <div class="card-footer bg-light py-3">
                    <div class="row align-items-center">
                        <div class="col-md-6 small text-muted">
                            <i class="fas fa-info-circle me-1"></i> Dernière modification: {{ $partenaire->updated_at->format('d/m/Y H:i') }}
                        </div>
                        <div class="col-md-6 text-md-end">
                            <span class="badge bg-warning text-dark">
                                <i class="fas fa-id-card me-1"></i> ID: {{ $partenaire->id }}
                            </span>
                        </div>
                    </div>
                </div>
