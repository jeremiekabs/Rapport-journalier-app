            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-lg">
                    ...
                    <div class="card-body p-5">
                        <form action="{{ route('produits.store') }}" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                            @csrf

                            <!-- Nom du Produit -->
                            <div class="mb-4">
                                <label for="nom" class="form-label fw-semibold">Nom du produit <span
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    <label for="prix_achat" class="form-label fw-semibold">Prix d'achat <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                ...
                                <!-- Indice -->
                                <div class="col-md-6 mb-4">
                                    <label for="indice" class="form-label fw-semibold">Indice <span
                                            class="text-danger">*</span></label>
                                    <input type="number" name="indice" id="indice" class="form-control" step="0.01"
                                        required>
                            ...
                            <div class="row">
                                ...
                                <!-- Catégorie -->
                                <div class="col-md-6 mb-4">
                                    <label for="categorie_id" class="form-label fw-semibold">Catégorie <span
                                            class="text-danger">*</span></label>
