...
@section('content')
                            ...
                            <div class="row g-4 mb-4">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input type="number" name="quantite"
                                            class="form-control border-start-0 ps-3 quantity-input" min="1" required
                                    ...
                                    <div class="form-text mt-2 d-flex align-items-center">
                                        ...
                                        Stock disponible : <span id="stock-display"
                                            class="fw-bold ms-1"> {{ $produits[0]->stock ?? 0 }} </span> —
                                        Prix unitaire : <span id="prix-display"
                                            class="fw-bold ms-1">{{ $produits[0]->prix ?? 0 }} €</span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input type="number" name="prix_nego" class="form-control border-start-0 ps-3"
                                            step="0.01" placeholder="Prix personnalisé">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            updateInfos(); // charger au démarrage
